...
export function UserHeader() {
  ...
  const handleChangePassword = async (currentPassword: string, newPassword: string) => {
    ...
    try {
      await userService.changePassword(usuario._id, newPassword, sessionStorage.getItem('vivipra_token') || '');
  ...
  const nombreCompleto = `${usuario.pnombre} ${usuario.snombre ? usuario.snombre + ' ' : ''}${usuario.papellido} ${usuario.sapellido}`.trim();
